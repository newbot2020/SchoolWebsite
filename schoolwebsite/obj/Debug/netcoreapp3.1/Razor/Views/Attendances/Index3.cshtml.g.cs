#pragma checksum "C:\Users\USER\Desktop\Projects\SchoolWebsite-master\SchoolWebsite\schoolwebsite\Views\Attendances\Index3.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4970f59e1483a7aa919654eb5f2797085d4a221f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4970f59e1483a7aa919654eb5f2797085d4a221f", @"/Views/Attendances/Index3.cshtml")]
...
<div class=""jumbotron"">
    <div class=""row"">
        ...
        <input class=""form-group col-2"" type=""search""");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("select", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "4970f59e1483a7aa919654eb5f2797085d4a221f6109", async() => {
                WriteLiteral("\r\n        ");
            }
            );
                ...
                $.post(""/Attendances/Datainfo"",
                    ...
                    function (data, status) {
                        ...
                        if (data[0].students.imagefilename == '') {
                            ...
                            var imageurl = '~/Images/2020/' + data[0].students.classinfo + '/' + data[0].students.");
                WriteLiteral(@"imagefilename;
                            var profileimage = '<img class=""rounded-circle"" style=""width:100px;height:100px;"" src=""' + imageurl + '"" />';
                        }
                        ...
                        <tr>
                            <td class=""col-2"">Class</td>
               ");
                WriteLiteral(@"             <td id=""class"" class=""col-4 text-center""></td>
                            <td class=""col-2""></td>
                        </tr>
                        <tr>
                            <td class=""col-2"">Section</td>
                        ...
                        <tr>
                            <td class=""col-2"">Address</td>
                    ");
                WriteLiteral(@"        <td id=""address"" class=""col-4 text-center""></td>
                            <td class=""col-2""></td>
                        </tr>`
                ...
                WriteLiteral(@"         <th>27</th>
                    ...
                    for (j = 0; j < data.length; j++) {
                        ...
                        for (i = 0; i < 31; i++) {
                            ...
                            rowoftable = '<td><input type=""checkbox"" class=");
                WriteLiteral(@"""checker"" id=""' + identity + '"" name=""' + identity +
                                '"" value=""""></input>' + '</td>';
                            checkboxhtml += rowoftable;
                        }
                        temporary_present_array.push((data[j][""day""]).split("",""));
                        ...
                        i = 0;
                                ...
                                for (j = 0; j <");
                WriteLiteral(@" temporary_present_array.length; j++) {
                                    for (l = 0; l < temporary_present_array[j].length; l++) {
